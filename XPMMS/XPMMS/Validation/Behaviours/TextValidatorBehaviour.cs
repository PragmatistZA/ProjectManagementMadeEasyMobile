...
namespace XPMMS.Validation.Behaviours
{
    public class TextValidatorBehaviour : Behavior<Entry>
    {
        ...
        {
            IsValid = (Regex.IsMatch(e.NewTextValue, textRegex, RegexOptions.IgnoreCase, TimeSpan.FromMilliseconds(250)));
